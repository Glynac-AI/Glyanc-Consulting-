        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-lcw-light-gray p-8 rounded-lg">
            <p className="text-lcw-text-light font-body">
              This page is under development. Learn about Paradigm's mission to support the development of the next generation of the internet through strategic investment and technical expertise.
            </p>
          </div>
        </div>
      </div>
